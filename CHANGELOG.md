...
## [0.19.3] - 2025-03-03
### Changed
- update energysystem viewer to v0.10.1

## [0.19.2] - 2025-02-28
### Fixed
- update pandera to v0.22.1
...
- update links on starting page
- exclude legacy scenarios from starting page
- update energysystem viewer to v0.10.0

## [0.18.0] - 2024-12-17
### Changed
- update comparison dashboard to v2.7.0

## [0.17.0] - 2024-12-04
### Added
- error message if upload validation fails; update dcd to v2.6.0

## [0.16.1] - 2024-12-03
### Fixed
- CSV upload in comparison dashboard
